...
robot.goto_given_conf([0,0,1,0,0,0])
...
start_pose = (fs_reference_poses[0][0] + rm.np.array([.25, .1, 0]), fs_reference_poses[0][1])
goal_pose = (fs_reference_poses[2][0] + rm.np.array([.2, .2, 0]), fs_reference_poses[2][1])
obj_start = obj.copy()
