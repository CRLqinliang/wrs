...
if __name__ == "__main__":
    env_setup()
    # 调用示例
    object_feasible_grasps_path = r"H:\Qin\wrs\wrs\HuGroup_Qin\data\grasps\Bottle\bottle_grasp_57.pickle"
    object_feasible_grasps = grasp_load(object_feasible_grasps_path)
    gripper = wrs_gripper_v3.WRSGripper3()
    grasp_data_path = r"H:\Qin\wrs\wrs\HuGroup_Qin\data\grasps\Bottle\grasp_random_position_bottle_robot_table_57.pickle"
