...
class nova2_gripper_v3_without_gripper(ri.SglArmRobotInterface):
    ...
    def setup_cc(self):
        ...
        self.cc.enable_innercd_by_id_list(id_list=[bd, mlb, ml0, ml1, ml2, ml3, ml4], type="into")
...
if __name__ == '__main__':
    ...
    robot = nova2_gripper_v3_without_gripper(enable_cc=True)
