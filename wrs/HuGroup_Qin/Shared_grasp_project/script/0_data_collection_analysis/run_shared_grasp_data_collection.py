...
def parse_args():
    ...
    parser.add_argument('--runs', type=int, default=17, help='运行次数')  # 0.3M  - Shared grasp 0.3M , feasible grasp 0.6M.
    parser.add_argument('--grasp_ids', type=int, nargs='+', default=[199], help='要处理的抓取ID列表')
