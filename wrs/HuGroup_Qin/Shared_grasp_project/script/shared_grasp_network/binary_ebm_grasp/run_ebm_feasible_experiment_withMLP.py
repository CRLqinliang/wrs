...
def run_ebm_experiment(hidden_dims, num_layers, dropout_rate, batch_size, 
    ...
    exp_name = f'ebm_multi_{objects_str}_h{len(hidden_dims)}_b{batch_size}_lr{learning_rate}_t{temperature}_r{data_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_g{grasp_type}_st{state_type}'
