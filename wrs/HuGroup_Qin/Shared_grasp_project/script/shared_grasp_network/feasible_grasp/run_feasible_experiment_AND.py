...
def run_bc_and_evaluation(hidden_dims, num_layers, dropout_rate, batch_size, 
    ...
    if model_mode == 'standard':
        ...
        init_exp_name = f'BC_{dataset_type}_{data_id}_h{len(hidden_dims)}_b{batch_size}_lr0.001_r{init_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_seed22'
        goal_exp_name = f'BC_{dataset_type}_{data_id}_h{len(hidden_dims)}_b{batch_size}_lr0.001_r{goal_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_seed22'
        ...
        # wandb配置
        and_exp_name = f'bc_and_{dataset_type}_{data_id}_i{init_ratio}_g{goal_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_g{grasp_type}'
        ...
        # 构建模型路径 - Robot
        robot_init_exp_name = f'BC_{dataset_type}_{data_id}_h{len(hidden_dims)}_b{batch_size}_lr0.001_r{robot_init_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_seed42'
        ...
        # 构建模型路径 - Table
        table_init_exp_name = f'BC_{dataset_type}_{data_id}_h{len(hidden_dims)}_b{batch_size}_lr0.001_r{table_init_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_seed42'
        ...
        # 构建模型路径 - Robot
        robot_goal_exp_name = f'BC_{dataset_type}_{data_id}_h{len(hidden_dims)}_b{batch_size}_lr0.001_r{robot_goal_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_seed42'
        ...
        # 构建模型路径 - Table
        table_goal_exp_name = f'BC_{dataset_type}_{data_id}_h{len(hidden_dims)}_b{batch_size}_lr0.001_r{table_goal_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}_seed42'
        ...
        # wandb配置
        and_exp_name = f'bc_and_rt_{dataset_type}_{data_id}_ri{robot_init_ratio}_ti{table_init_ratio}_rg{robot_goal_ratio}_tg{table_goal_ratio}_s{train_split}_q{int(use_quaternion)}_sl{int(use_stable_label)}'
        cmd.extend(['--wandb_project', 'bc_grasp_AND_RT_evaluation'])
        cmd.extend(['--wandb_name', and_exp_name])
