...
def anime_show_common_grasp(object_feasible_grasps, gripper, common_grasp_data_path):
    # 读取数据
    ...
    # 创建动画数据对象
    anime_data = AnimeData(init_poses, goal_poses, common_ids, gripper, object_feasible_grasps)
